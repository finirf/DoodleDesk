...
function Desk({ user }) {
  ...
  const { pendingDeleteId, setPendingDeleteId, deleteAccountDialog, setDeleteAccountDialog, deleteAccountDeleting, deleteAccountError, setDeleteAccountError, deleteAccountConfirmationMatches, deskMembersDialogOpen, setDeskMembersDialogOpen } = useDeskModalState()
  ...
  }, [deskShelves, setShelfActionError])
  ...
  const submitShelfRenameDialog = React.useCallback((event) => {
    ...
    setShelfRenameDialog({ isOpen: false, shelfId: null, value: '', originalName: '' })
  }, [commitDeskShelfRename, shelfRenameDialog])
