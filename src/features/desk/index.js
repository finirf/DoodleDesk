...
export { default as ActivityExportDialog } from './components/ActivityExportDialog'
export { default as EngagementTierBadge } from './components/EngagementTierBadge'
...
export { default as useDeskActivityCapture } from './hooks/useDeskActivityCapture'
...
export { default as useDeskEngagementMetrics } from './hooks/useDeskEngagementMetrics'
...
export { BUILT_IN_SHELVES, DECORATION_OPTIONS, FONT_OPTIONS, NOTE_OPTIONS } from './constants/deskConstants'
